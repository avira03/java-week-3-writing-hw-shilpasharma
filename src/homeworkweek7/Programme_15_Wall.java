 ...
 * height field. If the parameter is less than 0 it needs to set the height field value to   → TEST CODE: (Write bellow code into main method and run and compare result with
